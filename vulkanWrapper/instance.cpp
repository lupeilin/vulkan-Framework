...
namespace FF::Wrapper {
	...
	//辅助函数
	static VkResult CreateDebugUtilsMessageEXT(VkInstance instance,
	...
	Instance::Instance(bool enableValidationlayer) {
		...
		if (mEnableValidationLayer && !checkValidationLayersSupport()) {
	...
	bool Instance::checkValidationLayersSupport() {
		...
		for (const auto& layerName : validationLayers) {
			...
			for (const auto& layerProp : avalibleLayers) {
	...
	void Instance::setupDebugger() {
		...
		if (CreateDebugUtilsMessageEXT(mInstance, &createInfo, nullptr, &mDebugger) != VK_SUCCESS) {
